# Unified Tests Source (1032 - 1038)
...
Interest: الفائدة
Employers: المدراء
Co-workers: زملاء العمل
Stakeholders: أصحاب المصلحة أو المعنيين في المؤسسة
...
Enhance: تعزيز
Communicate: التواصل
Promotions: الترقية المهنية
Pay raise: زيادة في الرواتب
QUESTIONS:
1. Choose the answer to complete each statement.
a) Ethical workers are those who improve ……. | their profits | human relationships | the number of stakeholders
b) Workplace can be exposed to ……………. | unethical practices | unfair competition | regular audits
c) Lack of confidence between workers …….. | saves time and money | encourages human contact | affects work quality
...
4. Choose the most appropriate title | a) Decision making in companies. | b) Productivity factors in business. | c) Ethics at the workplace.

===TEST===
ID: 1033
TITLE: Corruption in the Health Sector
TEXT:
Corruption in the health sector can mean the difference between life and death. Poor people are the most affected. Medical staff can charge unofficial fees to attend to patients. They may demand bribes for medication which should be free. Corruption also costs lives when fake adulterated medications are sold to health services.
...
Staff: طاقم العمل
Affected: متأثر
Unofficial fees: رسوم غير رسمية
Patients: المرضى
Adulterated medications: أدوية المغشوشة
Embezzle: اختلاس
Budgets: الميزانيات
Reputation: السمعة
Qualified: مؤهل
Stolen: مسروق
Hamper efforts: إعاقة الجهود
Publish: نشر
Track: تتبع
Adequate pay: أجر كافٍ
Tackle: معالجة موضوع
Accountability: المسؤولية
Scrutinize: التدقيق في
Aware: مدرك
Ensure: ضمان
Equal opportunities: تكافؤ الفرص
QUESTIONS:
1. The text is taken from | a: a web site. | b: a book extract. | c: a news paper article.
2. Say whether the statements are true or false.
a. Corruption affects the poor the most.
b. People can be asked for a bribe in order to have health care.
c. Governments can’t fight funds disappearance.
d. We don’t have to know about hospitals budget to ensure good health care.
3. Answer the following questions according to the text.
a. What unethical behaviours are committed by the medical staff?
b. How can governments fight funds disappearance?
c. Is it possible for people to improve health services at the local level?
4. In which paragraph are the following ideas mentioned
a: health workers should be well paid in order to stop bribery.
b: some patient’s families give bribery to treat their relative.
...
TEXT:
In today's competitive world, many companies are under pressure to make profits. However, focusing only on financial success can sometimes lead to unethical behavior. Business ethics is the study of what is right and wrong in the world of commerce. It helps companies act responsibly and fairly.
...
Profits: الأرباح
Financial success: النجاح المالي
Commerce: التجارة
Fairly: بعدالة
Impact: الأثر
Employees: الموظفون
Customers: العملاء
Ensure fair wages: ضمان أجور عادلة
Resources: الموارد
False advertising: إعلانات مضللة
Cheap labor: العمالة الرخيصة
Unsafe: غير آمن
Damage: الإضرار بـ
Reputation: السمعة
Trust: الثقة
Consumers: المستهلكون
Contribute: المساهمة في
Society: المجتمع
Economy: الاقتصاد
QUESTIONS:
1. Identify the type of the text. | a) an extract from a book | b) a speech. | c) a web article.
2. Say whether the following sentences are true or false.
a- Business ethics is only about obeying the law.
b- Ethical businesses always put people and the environment first.
c- Companies that act unethically can lose public trust.
d- All successful companies are ethical.
3. Answer the following questions according to the text.
a- What is business ethics?
b- How do ethical businesses treat workers?
c- What are some examples of unethical practices?
d- Why is it important for businesses to act ethically?
4. Choose the general idea of the text. | a- How businesses increase profits | b- Why competition is necessary for business | c- The importance of ethics in business
...
Discovered: اكتشف
Ancient: قديم
Primitive farmers: مزارعون بدائيون
Vegetables: الخضروات
Grains: الحبوب
...
Traders: التجار
Shared: مشاركة
Complex irrigation: نظام ري معقد
Drainage systems: أنظمة الصرف
Fortified: محصن
Laid out: مخطط
Palaces: القصور
Granaries: مخازن الحبوب
Residents: السكان
Culture: الثقافة
Destroyed: دُمِّر
QUESTIONS:
...
c) that (§3)
d) their (§3)
5. Find in the text words or phrases that are opposite in meaning to the following.
a) modern (§1)
b) simple (§2)
c) low (§3)
...
TEXT:
Algeria has an impressive history with valuable cultural sites that are internationally acknowledged on UNESCO's Heritage List, with a total of seven recognized sites.
...
Recognized sites: مواقع معتمدة
Remains: بقايا
Ancient mosque: مسجد قديم
Architecture: الهندسة المعمارية
Influenced: أثر على
Mountain: جبل
Well-preserved: محفوظ بشكل جيد
Ruins: أنقاض
Unique adaptation: تكيف فريد
Earning: اكتساب
Founded: تأسست
Military colony: مستعمرة عسكرية
Heritage: التراث
Fascinating labyrinth: متاهة ساحرة
Preserve: الحفاظ على
...
Remarkable: رائع
QUESTIONS:
1. Identify the type of the text. | a) narrative. | b) expository. | c) argumentative.
2. Say whether the following statements are true or false.
a. Algeria's history is unknown to the world.
b. Djemila's Roman-style buildings are on mountains.
c. The Casbah of Algiers has a mix of old and new styles.
d. The M'Zab Valley and Ghardaia are only a few years old.
3. Answer the following questions according to the text.
a. How many sites in Algeria are recognized by UNESCO?
b. What specific features of Djemila ruins earned them a place on UNESCO's list?
c. Which sites have historical connections to Roman civilization?
4. Find what or who the underlined words in the text refer to.
a. this archaeological site (§2)
b. its (§2)
5. Find in the text words or phrases that are closest / opposite in meaning to the following.
a. old (§2) (closest)
b. situated (§3) (closest)
c. losing (§2) (opposite)
d. poor (§3) (opposite)
...
Trade: التجارة
Slavery: العبودية
Social inequality: التفاوت الاجتماعي
Rulers: الحكام
Perpetuate: تخليد
Immortalize: تخليد ذكرى
QUESTIONS:
(Use same structure as other tests - True/False, paragraph matching, open questions, reference words)

===TEST===
ID: 1038
TITLE: Ordinary Unethical Behaviour
TEXT:
Cheating, deception and other forms of unethical behaviour are widespread in business, sports, schools, and other arenas. While the media focus on extreme cases of cheating, less attention is paid to what researchers call "ordinary unethical behaviour."
...
Conflict: الصراع
Desire to maintain: الرغبة في الحفاظ على
Self-interest: المصلحة الشخصية
Boundaries: الحدود
Resolve: حل
Reinterpreting: إعادة تفسير
Honest mistake: خطأ غير مقصود
QUESTIONS:
(Use same structure as other tests)
