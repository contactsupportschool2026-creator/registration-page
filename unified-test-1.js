/* =========================================================
   Unified Test Engine
   Data is embedded so it works on GitHub Pages + local file
   ========================================================= */
...
Adapted from https://smallbusiness.chron.com/ethics-`,
    ...
    questions: `1. Choose the answer to complete each statement.
...
http://www.transparency.org/topic/detail/health`,
    ...
    questions: `1. The text is taken from
   - a: a web site.
   - b: a book extract.
   - c: a news paper article.
...
Adapted from Crane, A., & Matten, D. (2016). Business Ethics.`,
    ...
    questions: `1. Identify the type of the text.
...
4. Choose the general idea of the text.
   - a- How businesses increase profits
   - b- Why competition is necessary for business
   - c- The importance of ethics in business
...
Adapted from Britannica 2009`,
    ...
    questions: `1. Say whether the following statements are True or False.
...
We notice, too, that the civilizations of the past made slavery a practice that was not only tolerated but also legalised. It was the same attitude as regards social inequality which was often considered as a reality belonging to the natural order of things against no solution was possible. Besides, immense efforts were devoted for the erection of gigantic constructions, which in addition to satisfy practical aims, were expected to perpetuate the memory and the glory of the rulers who were eager to defy time and immortalise their names.`,
    ...
    questions: `1. What did ancient civilizations have in common according to the text?
2. What was necessary for a civilization to become prosperous?
3. What role did armies play in these civilizations?
4. What other common practices are mentioned (trade, slavery, social inequality, constructions)?
5. What was the purpose of the gigantic constructions?`
  },
...
Adapted from: ‘ethicalsystems.org’`,
    ...
    questions: `1. What is "ordinary unethical behaviour"?
2. Give examples mentioned in the text.
3. According to the studies, how much do people cheat?
4. What conflict do people experience when they have the opportunity to cheat?
5. How do people often resolve this conflict?`
  }
};
...
function closeTextOverlay() {
  ...
  document.getElementById("questions-display").textContent = currentTest.questions;
}
